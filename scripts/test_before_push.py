...
if __name__ == '__main__':
    ...
    # cyclegan train/test
    run('python train.py --model cycle_gan --name temp_cyclegan --dataroot E:\Graduate_Student\datasets\cyclegan\facades\facades --n_epochs 10 --n_epochs_decay 0 --save_latest_freq 10  --print_freq 1 --display_id -1')
    run('python test.py --model test --name selfie2anime --dataroot E:\Graduate_Student\datasets\GAN\selfie2anime\selfie2anime\testB --num_test 100 --model_suffix "_B" --no_dropout')
